...
$id = $_POST['id'];
$row = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `lienquan` WHERE `id`='".$id."' AND `status`='0' AND `nguoimua`='".$user['username']."'"));
...
<div class="modal-header">
    ...
    <h4 class="modal-title">Thông Tin Tài Khoản Liên Quân #<?php echo $row['id'];?></h4>
</div>
